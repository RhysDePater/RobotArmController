...
fname = 'EGB339_prac_exam_group_51.json';
...
for i = 1:2
    ...
    if current_run_flags.use_vision
        ...
        [ret_init_pos, ret_dest_pos] = EGB339_prac_exam_group_67(dobot_sim, init_image, dest_image, current_run_flags.use_vision);
        ...
        EGB339_prac_exam_group_67(dobot_sim, ret_init_pos, ret_dest_pos, false);
        ...
        EGB339_prac_exam_group_67(dobot_sim, true_init_pos, true_dest_pos, false);
    end
